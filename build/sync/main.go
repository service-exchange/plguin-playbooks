...
import (
	...
	"github.com/service-exchange/service-exchange-plugin-starter-template/build/sync/plan"
)

func main() {
	verbose := flag.Bool("verbose", false, "enable verbose output")
	flag.Usage = func() {
		fmt.Fprintf(flag.CommandLine.Output(), "Update a pluging directory with /service-exchange-plugin-starter-template/.\n")
