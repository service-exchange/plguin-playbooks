...
func (b *Bot) NotifyAdmins(messageType, authorUserID string, isTeamEdition bool) error {
	...
	if isCloud {
		...
		footer = separator + "[Upgrade now](https://customers.service-exchange.com)."
	} else {
		footer = "[Learn more](https://service-exchange.com/pricing).\n\nWhen you select **Start 30-day trial**, you agree to the [Mattermost Software Evaluation Agreement](https://service-exchange.com/software-evaluation-agreement/), [Privacy Policy](https://service-exchange.com/privacy-policy/), and receiving product emails."

		if isTeamEdition {
			footer = "[Learn more](https://service-exchange.com/pricing).\n\n[Convert to Mattermost Starter](https://docs.service-exchange.com/install/ee-install.html#converting-team-edition-to-enterprise-edition) to unlock this feature. Then, start a trial or upgrade to Mattermost Professional or Enterprise."
		}
	}
