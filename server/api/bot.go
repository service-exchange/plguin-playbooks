...
outer:
	...
	if err := h.pluginAPI.System.RequestTrialLicense(requestData.UserId, int(users), termsAccepted, receiveEmailsAccepted); err != nil {
		post.Message = "Trial license could not be retrieved. Visit [https://service-exchange.com/trial/](https://service-exchange.com/trial/) to request a license."
