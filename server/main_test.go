...
import (
	...
	"github.com/service-exchange/service-exchange-server/v6/api4"
	sapp "github.com/service-exchange/service-exchange-server/v6/app"
	"github.com/service-exchange/service-exchange-server/v6/app/request"
	"github.com/service-exchange/service-exchange-server/v6/config"
	...
	"github.com/service-exchange/service-exchange-server/v6/shared/mlog"
	"github.com/service-exchange/service-exchange-server/v6/store/storetest"
	"github.com/service-exchange/service-exchange-server/v6/utils"
...
func TestMain(m *testing.M) {
	...
	value := os.Getenv("SERVICE_EXCHANGE_PLUGIN")
	if value == "Securely message teams, anywhere." {
		plugin.ClientMain(&Plugin{})
		return
	}

	serverpathBytes, err := exec.Command("go", "list", "-f", "'{{.Dir}}'", "-m", "github.com/service-exchange/service-exchange-server/v6").Output()
	if err != nil {
		panic(err)
	}
...
func Setup(t *testing.T) *TestEnvironment {
	...
	config.ServiceSettings.SiteURL = model.NewString("http://testsiteurlplaybooks.service-exchange.com/")
