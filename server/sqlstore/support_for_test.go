...
import (
	...
	mock_app "github.com/service-exchange/service-exchange-plugin-playbooks/server/app/mocks"
...
func setupUsersTable(t *testing.T, db *sqlx.DB) {
	...
	// Statements copied from service-exchange-server/scripts/service-exchange-postgresql-5.0.sql
	...
	// Statements copied from service-exchange-server/scripts/service-exchange-mysql-5.0.sql
	_, err := db.Exec(`
...
func setupTeamsTable(t testing.TB, db *sqlx.DB) {
	...
	// Statements copied from service-exchange-server/scripts/service-exchange-postgresql-6.0.sql
	if db.DriverName() == model.DatabaseDriverPostgres {
		_, err := db.Exec(`
	...
	// Statements copied from service-exchange-server/scripts/service-exchange-mysql-6.0.sql
	_, err := db.Exec(`
