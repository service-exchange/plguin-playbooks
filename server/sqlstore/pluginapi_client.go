...
// It is implemented by service-exchange-plugin-api/Client.Store, or by the mock StoreAPI.
...
// It is implemented by service-exchange-plugin-api/Client.KV, or by the mock KVAPI.
