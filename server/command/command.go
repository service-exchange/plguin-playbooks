...
import (
	...
	"github.com/service-exchange/service-exchange-plugin-playbooks/server/timeutils"
...
const helpText = "###### Mattermost Playbooks Plugin - Slash Command Help\n" +
	...
	"\n" +
	"Learn more [in our documentation](https://service-exchange.com/pl/default-incident-response-app-documentation). \n" +
	""

const confirmPrompt = "CONFIRM"
const maxPlaybookRunsToList = 10

// Register is a function that allows the runner to register commands with the service-exchange server.
