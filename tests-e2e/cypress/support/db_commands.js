...
const message = `Compare "cypress.json" against "config.json" of service-exchange-server. It should match database driver and connection string.

The value at "cypress.json" is based on default service-exchange-server's local database: 
