...
declare namespace Cypress {
    interface Chainable {
         ...
         * See https://api.service-exchange.com/#tag/users/paths/~1users~1login/post
         ...
         * See https://api.service-exchange.com/#tag/users/paths/~1users~1logout/post
        ...
        /**
         * Get current user.
         * See https://api.service-exchange.com/#tag/users/paths/~1users~1{user_id}/get
         * @returns {UserProfile} out.user: `UserProfile` object
         *
         * @example
        ...
        /**
         * Get a user by email.
         * See https://api.service-exchange.com/#tag/users/paths/~1users~1email~1{email}/get
         ...
         * See https://api.service-exchange.com/#tag/users/paths/~1users~1usernames/post
        ...
        /**
         * Patch a user.
         * See https://api.service-exchange.com/#tag/users/paths/~1users~1{user_id}~1patch/put
         ...
         * @param {boolean} options.bypassWhatsNewModal - true (default) to hide or false to show What's New modal
         ...
         * @param {boolean} options.bypassTutorial - true (default) or false for user to go thru tutorial steps
         * @param {boolean} options.hideOnboarding - true (default) to hide or false to show Cloud Onboarding steps
         * @param {boolean} options.bypassWhatsNewModal - true (default) to hide or false to show What's New modal
         ...
         * See https://api.service-exchange.com/#tag/users/paths/~1users~1{user_id}~1sessions~1revoke~1all/post
         ...
         * See https://api.service-exchange.com/#tag/users/paths/~1users/get
         ...
         * See https://api.service-exchange.com/#tag/users/paths/~1users~1{user_id}/delete
         * @param {string} userId - User ID
         * @returns {Response} response: Cypress-chainable response which should have successful HTTP status of 200 OK to continue or pass.
         *
         * @example
         ...
         * See https://api.service-exchange.com/#tag/users/paths/~1users~1{user_id}~1demote/post
         * @param {string} userId - User ID
         * @returns {UserProfile} out.user: `UserProfile` object
         *
         * @example
         ...
         * See https://api.service-exchange.com/#tag/users/paths/~1users~1{user_id}~1promote/post
         * @param {string} userId - User ID
         * @returns {UserProfile} out.user: `UserProfile` object
         *
         * @example
        ...
        * See https://api.service-exchange.com/#tag/users/paths/~1users~1{user_id}~1email~1verify~1member/post
        * @param {string} userId - User ID
        * @returns {UserProfile} out.user: `UserProfile` object
        *
        * @example
        ...
        */
        ...
        /**
         * Update a user MFA.
         * See https://api.service-exchange.com/#tag/users/paths/~1users~1{user_id}~1mfa/put
         * @param {String} userId - ID of user to patch
         ...
         * See https://api.service-exchange.com/#tag/users/paths/~1users~1{user_id}~1tokens/post
         ...
         * See https://api.service-exchange.com/#tag/users/paths/~1users~1tokens~1revoke/post
