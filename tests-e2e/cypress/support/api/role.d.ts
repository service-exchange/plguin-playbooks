...
declare namespace Cypress {
    interface Chainable {
         ...
         * See https://api.service-exchange.com/#tag/roles/paths/~1roles~1name~1{role_name}/get
         ...
         * See https://api.service-exchange.com/#tag/roles/paths/~1roles~1names/post
        ...
        /**
         * Patch a role by ID.
         * See https://api.service-exchange.com/#tag/roles/paths/~1roles~1{role_id}~1patch/put
