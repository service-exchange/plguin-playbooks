...
declare namespace Cypress {
    interface Chainable {
         ...
         * See https://api.service-exchange.com/#tag/channels/paths/~1channels/post
         ...
         * See https://api.service-exchange.com/#tag/channels/paths/~1channels~1direct/post
         ...
         * See https://api.service-exchange.com/#tag/channels/paths/~1channels~1group/post
         ...
         * See https://api.service-exchange.com/#tag/channels/paths/~1channels~1{channel_id}/put
         ...
         * See https://api.service-exchange.com/#tag/channels/paths/~1channels~1{channel_id}~1patch/put
         ...
         * See https://api.service-exchange.com/#tag/channels/paths/~1channels~1{channel_id}~1privacy/put
         * @param {string} channelId - The channel ID to be patched
         ...
         * See https://api.service-exchange.com/#tag/channels/paths/~1channels~1{channel_id}/get
         ...
         * See https://api.service-exchange.com/#tag/channels/paths/~1teams~1name~1{team_name}~1channels~1name~1{channel_name}/get
         ...
         * See https://api.service-exchange.com/#tag/channels/paths/~1channels/get
         ...
         * See https://api.service-exchange.com/#tag/channels/paths/~1users~1{user_id}~1teams~1{team_id}~1channels/get
         * @returns {Channel[]} `out.channels` as `Channel[]`
         *
         * @example
         ...
         * See https://api.service-exchange.com/#tag/channels/paths/~1channels~1{channel_id}/delete
         ...
         * See https://api.service-exchange.com/#tag/channels/paths/~1channels~1{channel_id}~1members/post
         * @param {string} channelId - Channel ID
