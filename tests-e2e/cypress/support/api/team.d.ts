...
declare namespace Cypress {
    interface Chainable {
        ...
        /**
         * Create a team.
         * See https://api.service-exchange.com/#tag/teams/paths/~1teams/post
         ...
         * See https://api.service-exchange.com/#tag/teams/paths/~1teams~1{team_id}/delete
         ...
         * See https://api.service-exchange.com/#tag/teams/paths/~1teams~1{team_id}~1members~1{user_id}/delete
         ...
         * See https://api.service-exchange.com/#tag/teams/paths/~1teams~1name~1{name}/get
         ...
         * See https://api.service-exchange.com/#tag/teams/paths/~1teams/get
         ...
         * See https://api.service-exchange.com/#tag/teams/paths/~1users~1{user_id}~1teams/get
         ...
         * See https://api.service-exchange.com/#tag/teams/paths/~1teams~1{team_id}~1members/post
        ...
        /**
         * Get team members.
         * See https://api.service-exchange.com/#tag/teams/paths/~1teams~1{team_id}~1members/get
         * @param {string} teamId - team ID
         ...
         * See https://api.service-exchange.com/#tag/teams/paths/~1teams~1{team_id}~1members~1batch/post
         * @param {string} teamId - team ID
         ...
         * See https://api.service-exchange.com/#tag/teams/paths/~1teams~1{team_id}~1members~1{user_id}~1schemeRoles/put
         * @param {string} teamId - team ID
