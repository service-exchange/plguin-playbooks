...
declare namespace Cypress {
    interface Chainable {
         ...
         * See https://api.service-exchange.com/#tag/status/paths/~1users~1{user_id}~1status/put
         ...
         * See https://api.service-exchange.com/#tag/status/paths/~1users~1{user_id}~1status/get
         ...
         * See https://api.service-exchange.com/#tag/custom_status/paths/~1users~1{user_id}~1status/custom/put
         ...
         * See https://api.service-exchange.com/#tag/custom_status/paths/~1users~1{user_id}~1status/custom/delete
         * @param {UserCustomStatus} customStatus - custom status to be updated
         *
         * @example
