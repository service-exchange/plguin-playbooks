...
declare namespace Cypress {
    interface Chainable {
         ...
         * See https://api.service-exchange.com/#tag/system/paths/~1license~1client/get
        ...
        *    cy.apiRequireLicenseForFeature('LDAP', 'SAML');
         ...
         * See https://api.service-exchange.com/#tag/system/paths/~1license/post
         * @param {String} filePath - path of the license file relative to fixtures folder
         * @returns {Response} response: Cypress-chainable response which should have successful HTTP status of 200 OK to continue or pass.
         *
         * @example
         *   const filePath = 'service-exchange-license.txt';
         ...
         * See https://api.service-exchange.com/#tag/system/paths/~1trial-license/post
         ...
         * See https://api.service-exchange.com/#tag/system/paths/~1license/delete
         * @returns {Response} response: Cypress-chainable response which should have successful HTTP status of 200 OK to continue or pass.
         *
         * @example
         *   cy.apiDeleteLicense();
         ...
         * See https://api.service-exchange.com/#tag/system/paths/~1config/put
         ...
         * See https://api.service-exchange.com/#tag/system/paths/~1config~1reload/post
         * @returns {AdminConfig} `out.config` as `AdminConfig`
         *
         * @example
        ...
        /**
         * Get configuration.
         * See https://api.service-exchange.com/#tag/system/paths/~1config/get
        ...
        /**
         * Get analytics.
         * See https://api.service-exchange.com/#tag/system/paths/~1analytics~1old/get
         ...
         * See https://api.service-exchange.com/#tag/system/paths/~1caches~1invalidate/post
         * @returns {Object} `out.data` as response status
         *
         * @example
