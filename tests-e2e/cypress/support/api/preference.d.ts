...
declare namespace Cypress {
    interface Chainable {
        ...
        // *******************************************************************************
        // Preferences
        // https://api.service-exchange.com/#tag/preferences
        // *******************************************************************************

        /**
         * Save a list of the user's preferences.
         * See https://api.service-exchange.com/#tag/preferences/paths/~1users~1{user_id}~1preferences/put
         ...
         * See https://api.service-exchange.com/#tag/preferences/paths/~1users~1{user_id}~1preferences/get
         * @param {string} userId - User ID
        ...
        /**
         * Save What's New modal preference.
         * See https://api.service-exchange.com/#tag/preferences/paths/~1users~1{user_id}~1preferences/put
         * @param {string} userId - User ID
         * @param {string} value - options are 'true' or 'false'
         * @returns {Response} response: Cypress-chainable response which should have successful HTTP status of 200 OK to continue or pass.
         *
         * @example
         *   cy.apiHideSidebarWhatsNewModalPreference('user-id', 'false');
         */
        apiHideSidebarWhatsNewModalPreference(userId: string, value: string): Chainable<Response>;
    }
}
