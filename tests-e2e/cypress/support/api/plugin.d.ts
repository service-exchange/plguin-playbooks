...
declare namespace Cypress {
    interface Chainable {
        ...
        /**
         * Get plugins.
         * See https://api.service-exchange.com/#tag/plugins/paths/~1plugins/get
        ...
        /**
         * Upload plugin.
         * See https://api.service-exchange.com/#tag/plugins/paths/~1plugins/post
         ...
         * See https://api.service-exchange.com/#tag/plugins/paths/~1plugins~1install_from_url/post
        ...
        /**
         * Enable plugin.
         * See https://api.service-exchange.com/#tag/plugins/paths/~1plugins~1{plugin_id}~1enable/post
        ...
        /**
         * Disable plugin.
         * See https://api.service-exchange.com/#tag/plugins/paths/~1plugins~1{plugin_id}~disable/post
        ...
        /**
         * Remove plugin.
         * See https://api.service-exchange.com/#tag/plugins/paths/~1plugins~1{plugin_id}/delete
