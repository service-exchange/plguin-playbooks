...
function generateTestReport(summary, isUploadedToS3, reportLink, environment, testCycleKey) {
    ...
    if (FULL_REPORT === 'true') {
        ...
        return {
            ...
            icon_url: 'https://www.service-exchange.org/wp-content/uploads/2016/04/icon.png',
            attachments: [{
                color: testResult.color,
                author_name: 'Webapp End-to-end Testing',
                author_icon: 'https://www.service-exchange.org/wp-content/uploads/2016/04/icon.png',
                author_link: 'https://www.service-exchange.com',
                title,
                fields: [
                    {
                        short: false,
...
function generateTitle() {
    ...
    if (MM_DOCKER_IMAGE && MM_DOCKER_TAG) {
        dockerImageLink = ` with [${MM_DOCKER_IMAGE}:${MM_DOCKER_TAG}](https://hub.docker.com/r/service-exchange/${MM_DOCKER_IMAGE}/tags?name=${MM_DOCKER_TAG})`;
    }
...
function generateDiagnosticReport(summary, serverInfo) {
    ...
    return {
        ...
        attachments: [{
            ...
            author_icon: 'https://www.service-exchange.org/wp-content/uploads/2016/04/icon.png',
            author_link: 'https://community.service-exchange.com/core/channels/ui-test-automation',
