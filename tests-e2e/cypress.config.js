...
module.exports = defineConfig({
    ...
    viewportWidth: 1300,
    env: {
        adminEmail: 'sysadmin@sample.service-exchange.com',
        adminUsername: 'sysadmin',
        adminPassword: 'Sys@dmin-sample1',
        allowedUntrustedInternalConnections: 'localhost',
        dbClient: 'postgres',
        dbConnection:
        'postgres://mmuser:mostest@localhost/service-exchange_test?sslmode=disable&connect_timeout=10',
        elasticsearchConnectionUrl: 'http://localhost:9200',
        firstTest: false,
        keycloakAppName: 'service-exchange',
        ...
        minioS3Bucket: 'service-exchange-test',
