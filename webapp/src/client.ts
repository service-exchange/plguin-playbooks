...
import {GetStateFunc} from 'service-exchange-redux/types/actions';
import {UserProfile} from '@service-exchange/types/users';
import {Channel} from '@service-exchange/types/channels';
import {IntegrationTypes} from 'service-exchange-redux/action_types';
...
export function exportChannelUrl(channelId: string) {
    const exportPluginUrl = '/plugins/com.service-exchange.plugin-channel-export/api/v1';
