...
import General from 'service-exchange-redux/constants/general';
import {GlobalState} from '@service-exchange/types/store';
import {GlobalState as WebGlobalState} from 'service-exchange-webapp/types/store';
import {getConfig} from 'service-exchange-redux/selectors/entities/general';
import {getCurrentTeamId, getMyTeams} from 'service-exchange-redux/selectors/entities/teams';
import {getCurrentChannelId} from 'service-exchange-redux/selectors/entities/channels';
import {getUsers, getMyCurrentChannelMembership} from 'service-exchange-redux/selectors/entities/common';
import {UserProfile} from '@service-exchange/types/users';
import {sortByUsername} from 'service-exchange-redux/utils/user_utils';
import {IDMappedObjects} from '@service-exchange/types/utilities';
import {getCurrentUser} from 'service-exchange-redux/selectors/entities/users';

import {
    haveIChannelPermission,
    haveISystemPermission,
    haveITeamPermission,
} from 'service-exchange-redux/selectors/entities/roles';

import Permissions from 'service-exchange-redux/constants/permissions';
...
// sortAndInjectProfiles is an unexported function copied from service-exchange-redux, it is called
