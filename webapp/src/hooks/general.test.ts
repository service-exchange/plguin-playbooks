...
import {getProfilesByIds, getProfilesInTeam, getProfilesInChannel} from 'service-exchange-redux/actions/users';
...
jest.mock('service-exchange-redux/actions/users', () => ({
