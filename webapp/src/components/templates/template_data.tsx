...
import MattermostLogo from 'src/components/assets/service-exchange_logo_svg';
...
export const PresetTemplates: PresetTemplate[] = preprocessTemplates([
            ...
            checklists: [
                {
                    title: 'Pre-day one',
                    items: [
                        newChecklistItem('Complete the [Onboarding Systems Form in the IT HelpDesk](https://helpdesk.service-exchange.com/support/home)'),
                        newChecklistItem(
                            ...
                            mtrim`Managers play a large role in setting their new direct report up for success and making them feel welcome by setting clear expectations and preparing the team and internal stakeholders for how they can help new colleagues integrate and connect organizationally and culturally.
                                ...
                                * **AOR clarity:** Identify AORs that are relevant for your new hire, and indicate any AORs that your new hire will [DRI](https://handbook.service-exchange.com/company/about-service-exchange/list-of-terms#dri) or act as backup DRI. As needed, clarify AOR transitions with internal stakeholders ahead of your new hire's start date. See [AOR page](https://handbook.service-exchange.com/operations/operations/areas-of-responsibility) Include the interview panel and their respective focus areas.
                                * **Assign an Onboarding Peer:** The Onboarding Peer or peers should be an individual or group of people that can help answer questions about the team, department and Mattermost. In many ways, an Onboarding Peer may be an [end-boss](https://handbook.service-exchange.com/company/about-service-exchange/mindsets#mini-boss-end-boss) for specific AORs. Managers should ask permission of a potential Onboarding Peer prior to assignment.`,
                        ),
                    ],
                },
                {
                    ...
                    items: [
                        newChecklistItem(
                            'Introduce our new staff member in the [Welcome Channel](https://community.service-exchange.com/private-core/channels/welcome)',
                        ...
                        newChecklistItem(
                            'Review Team [AORs](https://handbook.service-exchange.com/operations/operations/areas-of-responsibility)',
                ...
                },
                {
                    title: 'Month one',
                    items: [
                        newChecklistItem('Review Company and Team [V2MOMs](https://handbook.service-exchange.com/company/how-to-guides-for-staff/how-to-v2mom)'),
                        newChecklistItem('Align on role responsibilities and expectations'),
                        newChecklistItem(
                            'COM Introduction',
                            'New team members are invited to introduce themselves at [COM](https://handbook.service-exchange.com/operations/operations/company-cadence#customer-obsession-meeting-aka-com) during their second week. If they\'re not comfortable doing their own introduction, Managers will do so on their behalf.',
                        ),
                        newChecklistItem(
                            '[Shoulder Check](https://handbook.service-exchange.com/company/about-service-exchange/mindsets#shoulder-check)',
                ...
                },
                {
                    ...
                    items: [
                        newChecklistItem(
                            ...
                            'Managers are notified to kick off the [New Colleague Review Process](https://handbook.service-exchange.com/contributors/onboarding#new-colleague-90-day-feedback-process) on their new staff member\'s 65th day. The feedback will include a summary of the new staff member\'s responsibilities during the first 90 days. Managers should communicate these responsibilities to the new staff member during their first week.',
                        ),
                    ],
                },
                {
    ...
    },
    {
        ...
        template: {
            ...
            checklists: [
                {
                    ...
                    items: [
                        ...
                        newChecklistItem(
                            ...
                            '',
                            '/cloud create playbooks-bug-bash-t0 --license te --image service-exchange/service-exchange-team-edition --test-data --version master',
                        ),
                        newChecklistItem(
                        ...
                        newChecklistItem(
                            ...
                            mtrim`From a command line, login to each server in turn via [\`mmctl\`](https://github.com/service-exchange/mmctl), and configure, e.g.:
                                \`\`\`
                                for server in playbooks-bug-bash-t0 playbooks-bug-bash-e0 playbooks-bug-bash-e10 playbooks-bug-bash-e20; do
                                    mmctl auth login https://$server.test.service-exchange.cloud --name $server --username sysadmin --password-file <(echo "Sys@dmin123");
                        ...
                        newChecklistItem(
                            ...
                            mtrim`From a command line, login to each server in turn via [\`mmctl\`](https://github.com/service-exchange/mmctl), and configure, e.g.:
                                ...
                                for server in playbooks-bug-bash-t0 playbooks-bug-bash-e0 playbooks-bug-bash-e10 playbooks-bug-bash-e20; do
                                    mmctl auth login https://$server.test.service-exchange.cloud --name $server --username sysadmin --password-file <(echo "Sys@dmin123");
                                    mmctl plugin install-url --force https://github.com/service-exchange/service-exchange-plugin-playbooks/releases/download/v1.22.0%2Balpha.3/playbooks-1.22.0+alpha.3.tar.gz
                                done
                                \`\`\``,
                        ),
                        newChecklistItem(
            ...
            **Release Link**: TBD
            **Zoom**: TBD
            **Triage Filter**: https://service-exchange.atlassian.net/secure/RapidBoard.jspa?rapidView=68&projectKey=MM&view=planning.nodetail&quickFilter=332&issueLimit=100

            | Servers |
            | -- |
            | [T0](https://playbooks-bug-bash-t0.test.service-exchange.cloud) |
            | [E0](https://playbooks-bug-bash-e0.test.service-exchange.cloud) |
            | [E10](https://playbooks-bug-bash-e10.test.service-exchange.cloud) |
            | [E20](https://playbooks-bug-bash-e20.test.service-exchange.cloud) |
