...
import {getCurrentChannel, getChannelsNameMapInCurrentTeam} from 'service-exchange-redux/selectors/entities/channels';
...
import {getCurrentTeam} from 'service-exchange-redux/selectors/entities/teams';
...
const RHSAbout = (props: Props) => {
    ...
    const setOwnerUtil = async (userId?: string) => {
        ...
        if (response.error) {
            // TODO: Should be presented to the user? https://service-exchange.atlassian.net/browse/MM-24271
