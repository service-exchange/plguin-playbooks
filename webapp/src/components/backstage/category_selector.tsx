...
import {makeGetCategoriesForTeam} from 'service-exchange-redux/selectors/entities/channel_categories';

import {ChannelCategory} from '@service-exchange/types/channel_categories';
