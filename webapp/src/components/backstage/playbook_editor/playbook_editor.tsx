...
import {selectTeam} from 'service-exchange-redux/actions/teams';
import {fetchMyChannelsAndMembers} from 'service-exchange-redux/actions/channels';
import {fetchMyCategories} from 'service-exchange-redux/actions/channel_categories';
import {useDispatch, useSelector} from 'react-redux';
import {StarOutlineIcon, StarIcon} from '@service-exchange/compass-icons/components';

import {getCurrentUserId} from 'service-exchange-webapp/packages/service-exchange-redux/src/selectors/entities/common';
