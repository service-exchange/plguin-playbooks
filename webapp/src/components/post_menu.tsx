...
import {isSystemMessage} from 'service-exchange-redux/utils/post_utils';
import {getPost} from 'service-exchange-redux/selectors/entities/posts';
import {getChannel} from 'service-exchange-redux/selectors/entities/channels';
