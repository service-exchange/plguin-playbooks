...
import {PluginRegistry} from 'service-exchange-webapp/plugins/registry';
...
import WebsocketEvents from 'service-exchange-redux/constants/websocket';
import {General} from 'service-exchange-redux/constants';

import {loadRolesIfNeeded} from 'service-exchange-webapp/packages/service-exchange-redux/src/actions/roles';
import {FormattedMessage} from 'react-intl';

import {ApolloClient, InMemoryCache, ApolloProvider, NormalizedCacheObject, HttpLink} from '@apollo/client';

import {getCurrentChannel} from 'service-exchange-redux/selectors/entities/channels';
...
// From service-exchange-webapp/utils
...
export default class Plugin {
    ...
    public initialize(registry: PluginRegistry, store: Store<GlobalState>): void {
        ...
        // in our version of the service-exchange-redux, since webapp only does it in its copy.
